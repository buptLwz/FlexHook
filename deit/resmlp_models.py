...
def resmlp_12(pretrained=False,dist=False, **kwargs):
    ...
    if pretrained:
        if dist:
          url_path = "deit/resmlp_12_dist.pth"
        else:
          url_path = "deit/resmlp_12_no_dist.pth"
...
def resmlp_24(pretrained=False,dist=False,dino=False, **kwargs):
    ...
    if pretrained:
        if dist:
          url_path = "deit/resmlp_24_dist.pth"
        elif dino:
          url_path = "deit/resmlp_24_dino.pth"
        else:
          url_path = "deit/resmlp_24_no_dist.pth"
        checkpoint = torch.hub.load_state_dict_from_url(
            url=url_path,
            map_location="cpu", check_hash=True
        )
...
def resmlp_36(pretrained=False,dist=False, **kwargs):
    ...
    if pretrained:
        if dist:
          url_path = "deit/resmlp_36_dist.pth"
        else:
          url_path = "deit/resmlp_36_no_dist.pth"
        checkpoint = torch.hub.load_state_dict_from_url(
            url=url_path,
            map_location="cpu", check_hash=True
        )
...
def resmlpB_24(pretrained=False,dist=False, in_22k = False, **kwargs):
    ...
    if pretrained:
        if dist:
          url_path = "deit/resmlpB_24_dist.pth"
        elif in_22k:
          url_path = "deit/resmlpB_24_22k.pth"
        else:
          url_path = "deit/resmlpB_24_no_dist.pth"
