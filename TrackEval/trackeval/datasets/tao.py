...
class TAO(_BaseDataset):
    ...
    def _merge_categories(self, annotations):
        """
        Merges categories with a merged tag. Adapted from TAO-Dataset
    ...
    def _fill_video_ids_inplace(self, annotations):
        """
        Fills in missing video IDs inplace. Adapted from TAO-Dataset/
    ...
    def _make_track_ids_unique(annotations):
        """
        Makes the track IDs unqiue over the whole annotation set. Adapted from TAO-Dataset/
